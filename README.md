...
### กราฟ 03 - การเปลี่ยนแปลงปริมาณการจราจรช่วงเช้าในกรุงเทพมหานคร ระหว่างก่อนโควิด-19 (2017-2019) และหลังโควิด-19 (2022-2024)
...
### กราฟ 04 - การเปลี่ยนแปลงปริมาณการจราจรช่วงระหว่างวันในกรุงเทพมหานคร ระหว่างก่อนโควิด-19 (2017-2019) และหลังโควิด-19 (2022-2024)
...
### กราฟ 05 - การเปลี่ยนแปลงปริมาณการจราจรช่วงเย็นในกรุงเทพมหานคร ระหว่างก่อนโควิด-19 (2017-2019) และหลังโควิด-19 (2022-2024)
...
### กราฟ 06 - การเปรียบเทียบการเปลี่ยนแปลงของปริมาณการจราจร ณ จุดสำรวจเดิม จำแนกตามช่วงเวลาของวัน
...
### กราฟ 06 - ทางแยกที่มีปริมาณรถเฉลี่ยสูงสุดและต่ำสุด
...
### กราฟ 8 - ดัชนีปริมาณรถตามเงื่อนไขการจับคู่ข้อมูล (ตัวอย่าง)
...
### กราฟ 9 - Boxplot (Distribution of Traffic Volume by COVID Period)
...
ค่าผิดปกติ (Outliers):
ทั้งสามช่วงเวลาปรากฏจุดหมุดสีดำ (Outliers) ที่อยู่เหนือเส้นขอบบน (Upper Whisker) เป็นจำนวนมาก โดยเฉพาะในช่วง Before และ After COVID ซึ่งหมายถึง จุดสำรวจหรือทางแยกที่มีปริมาณการจราจรหนาแน่นสูงเป็นพิเศษ (เช่น ถนนสายหลักหรือจุดตัดสำคัญในกรุงเทพฯ) ที่มักมีปริมาณรถพุ่งสูงเกินกว่าค่าเฉลี่ยปกติของภาพรวมทั้งหมดครับ


### กราฟ 10 — แต่ละหน่วยอยู่เหนือหรือต่ำกว่าฐาน
...
### กราฟ 11 — สถานที่ที่มีการเปลี่ยนแปลงปริมาณรถเด่นชัด
...
### กราฟ 12 - ปริมาณรถเฉลี่ยจำแนกตามช่วงโควิด-19 และสถานะการล็อกดาวน์
...
### กราฟ 13 - Traffic Volumn Density Heatmaps by COVID Period & Lockdown Status
...
สรุปผลการวิเคราะห์ข้อมูลการจราจรจากกราฟ Heatmap ทั้งสองมุมมอง 
 1. เปรียบเทียบตามช่วงเวลา COVID (ภาพ A - โทนสีฟ้า)ปริมาณรถสูงสุด: กลุ่ม Passenger Car (รถยนต์นั่งส่วนบุคคล) มีปริมาณการใช้งานหนาแน่นที่สุดในทุกช่วงเวลา โดยช่วง Before COVID สูงที่สุดถึง 5,563.0 คัน   แนวโน้มการลดลง: ปริมาณการจราจรโดยรวมค่อย ๆ ลดลงจากช่วงก่อนโควิด ($5,563.0$ คัน) มาสู่ช่วงระหว่างโควิด ($4,947.5$ คัน) และหลังโควิด ($4,675.0$ คัน) ตามลำดับ ตามรูปแบบการเดินทางที่เปลี่ยนไป   ประเภทรถอื่นๆ: รถกลุ่ม Pickup/Van รองลงมาอยู่ที่ระดับประมาณ $1,600 - 1,900$ คัน ขณะที่รถบรรทุก, รถบัส และรถตุ๊กตุ๊ก มีปริมาณค่อนข้างน้อยและคงที่ในแต่ละช่วง
 2. เปรียบเทียบช่วง Lockdown กับ Not Lockdown (ภาพ B - โทนสีส้ม)ผลกระทบจากมาตรการ: ในช่วง Lockdown ปริมาณรถยนต์นั่งส่วนบุคคลและรถปิคอัพ/รถตู้ลดลงอย่างเห็นได้ชัดเมื่อเปรียบเทียบกับช่วง Not Lockdown (เช่น Passenger Car ช่วง Lockdown อยู่ที่ $4,895.0$ คัน เทียบกับ $4,990.8$ คันในช่วง Not Lockdown)   พฤติกรรมการเดินทาง: สะท้อนให้เห็นว่ามาตรการจำกัดการเดินทางและการทำงานจากที่บ้าน (WFH) ในช่วงล็อกดาวน์ส่งผลให้ปริมาณการจราจรบนท้องถนนลดลงอย่างมีนัยสำคัญ
    
### กราฟ 14 — การเปลี่ยนแปลงสัดส่วนรถแต่ละประเภทเทียบกับก่อนโควิด

![กราฟ 11: สัดส่วนหมวดเล็กเปลี่ยนอย่างไร](BKK6/fig/11.png)

กราฟแสดงส่วนต่างของสัดส่วนรถแต่ละประเภทจากก่อนโควิด ในหน่วยจุดเปอร์เซ็นต์ จากหน่วยสำรวจ 719 หน่วย แท่งด้านขวาหมายถึงสัดส่วนเพิ่มขึ้น ด้านซ้ายหมายถึงลดลง โดยสีส้มแทนช่วงระหว่างโควิด และสีเขียวแทนช่วงหลังโควิด

รถยนต์นั่งรวมแท็กซี่/แวนมีสัดส่วนเพิ่มขึ้นมากที่สุด โดยเพิ่ม 0.80 จุดเปอร์เซ็นต์ระหว่างโควิด และ 1.67 จุดเปอร์เซ็นต์หลังโควิด รถบรรทุกมีสัดส่วนเพิ่มขึ้นเช่นกัน ขณะที่รถตู้/ปิคอัพ รถเมล์เล็ก และรถสามล้อมีสัดส่วนลดลงทั้งสองช่วง ส่วนรถเมล์ใหญ่/รถทัวร์เพิ่มขึ้นเล็กน้อยระหว่างโควิด ก่อนลดลงหลังโควิด

การเพิ่มขึ้นของสัดส่วนไม่ได้หมายความว่าจำนวนรถประเภทนั้นเพิ่มขึ้นเสมอไป เพราะขึ้นอยู่กับจำนวนรถประเภทอื่นด้วย จึงยังใช้สรุปว่าผู้เดินทางเปลี่ยนจากรถสาธารณะไปใช้รถส่วนตัวไม่ได้

### กราฟ 15 — สัดส่วนข้อมูลสำรวจจำแนกตามวันในสัปดาห์

![กราฟ 14: วันสำรวจของกลุ่มจับคู่เหมือนกันหรือไม่](BKK6/fig/14.png)

กราฟแสดงร้อยละของแถวสำรวจในแต่ละวัน แยกตามช่วงก่อน ระหว่าง และหลังโควิด จากข้อมูล 3,045 แถวใน 721 หน่วยจับคู่ โดยสัดส่วนทั้งเจ็ดวันของแต่ละช่วงรวมเป็น 100%

ข้อมูลส่วนใหญ่อยู่ในวันจันทร์ถึงศุกร์ ส่วนวันเสาร์และอาทิตย์มีน้อยมาก สัดส่วนวันสำรวจแตกต่างกันระหว่างสามช่วง เช่น วันอังคารมีสัดส่วนลดลง ขณะที่วันพฤหัสบดีมีสัดส่วนเพิ่มขึ้นจากก่อนถึงหลังโควิด

แม้จะจับคู่ทางแยก ถนน และช่วงเวลาเดียวกันแล้ว องค์ประกอบของวันสำรวจยังต่างกัน ซึ่งอาจมีส่วนต่อผลเปรียบเทียบปริมาณรถ ทั้งนี้ กราฟแสดงสัดส่วนรายการสำรวจ ไม่ใช่ปริมาณรถ จึงใช้บอกไม่ได้ว่าวันใดรถมากหรือรถติดกว่า และยังไม่ได้แยกวันหยุดหรือเทศกาล

### สรุป Action plan กราฟ Strategic Traffic Action Priority Matrix คือเมทริกซ์การจัดลำดับความสำคัญเชิงนโยบาย ซึ่งเปลี่ยนข้อมูลพฤติกรรมการเดินทางหลังโควิดให้กลายเป็น แผนปฏิบัติการ (Action Plan) ที่นำไปใช้งานได้จริง โดยแบ่งการวิเคราะห์ออกเป็น 2 แกนหลัก และ 4 กลุ่มนโยบาย ดังนี้
...
🟢 1. กลุ่มฟื้นฟูและสนับสนุน (SUPPORT & REVITALIZE — ซ้ายล่าง)
...
🔵 2. กลุ่มจัดการประสิทธิภาพ (MANAGE EFFICIENCY — ขวาล่าง)
...
🟠 3. กลุ่มเฝ้าระวังและจัดระเบียบ (MONITOR & REGULATE — ซ้ายบน)
รถในกลุ่ม: ยานพาหนะที่มีอัตราการฟื้นตัวเกิน 100% แต่ปริมาณรวมยังน้อย (จุดวงกลมสีฟ้าด้านบนสุด)
...
🔴 4. กลุ่มควบคุมด่วน (URGENT CONTROL — ขวาบน)
